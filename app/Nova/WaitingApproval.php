    ...
    public function fields(Request $request)
    {
        return [
            ...
            Image::make('Before Photo','original')->resolveUsing(function ($original) {
                ...
                if (!empty($original['image']) || !empty($original['thumbnail'])) {
                    return empty($original['image']) ?  $original['thumbnail']:$original['image'];
                }
            ...
            Image::make('Changes Photo','changes')->resolveUsing(function ($changes) {
                ...
                if (!empty($changes['image']) || !empty($changes['thumbnail'])) {
                    return empty($changes['image']) ?  $changes['thumbnail']:$changes['image'];
                }
